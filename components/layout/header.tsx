...
export function Header({
    ...
    if (variant === "dashboard") {
        return (
            <header className="relative w-full bg-linear-to-r from-primary via-primary to-primary/90 shadow-xl border-b-2 border-primary/20">
                    ...
                    <div className="flex items-center justify-between gap-3 md:gap-6">
                        ...
                        <div className="flex items-center gap-2 md:gap-3 flex-1">
                            {showBackButton && (
                                <Link
                                    href={backHref}
                                    className="shrink-0 flex items-center justify-center h-8 w-8 md:h-10 md:w-10 rounded-full bg-white/10 hover:bg-white/20 text-white transition-all duration-200 backdrop-blur-sm border border-white/20 hover:scale-105"
                                    title="Kembali"
                                >
    ...
    return (
        <header className="relative w-full bg-linear-to-br from-primary to-primary/90 shadow-xl border-b-2 border-primary/20">
            <div className="container mx-auto px-4 py-3 md:py-5">
                <div className="flex justify-center items-center gap-2 md:gap-3 shrink-0">
                    {/* Alfamart Logo */}
